...
#define SIGNAL_A_BIT                       2
#define SIGNAL_A_MASK                      (0x01 << SIGNAL_A_BIT)
#define SIGNAL_A_PORT                      P5
#define SIGNAL_A_IN                        SIGNAL_A_PORT->IN

#define SIGNAL_B_BIT                       6
#define SIGNAL_B_MASK                      (0x01 << SIGNAL_B_BIT)
#define SIGNAL_B_PORT                      P3
#define SIGNAL_B_IN                        SIGNAL_B_PORT->IN
